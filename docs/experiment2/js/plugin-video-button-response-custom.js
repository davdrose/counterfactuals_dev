var jsPsychVideoButtonResponse = (function (jspsych) {
    ...
    class VideoButtonResponsePlugin {
      ...
      `);
            ...
            var buttonGroupElement = display_element.querySelector("#jspsych-video-button-response-btngroup");
            buttonGroupElement.style.visibility = "hidden";

            // function to show buttons after the video ends
            function showButtons() {
                buttonGroupElement.style.visibility = "visible";
                enable_buttons(); // Re-enable button clicks
            }
            ...
            function button_response(e) {
                console.log("in `button_response`")
                console.log(e);
